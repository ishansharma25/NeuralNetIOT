            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={handleModelChange} value={selectedModel}>
                ...
                <SelectContent className="bg-white">
                  <SelectItem value="attgru.h5" className="hover:bg-purple-100">Attention GRU Model (Attgru.h5)</SelectItem>
                  <SelectItem value="attlstm.h5" className="hover:bg-purple-100">Attention LSTM Model (Attlstm.h5)</SelectItem>
                  <SelectItem value="attrnn.h5" className="hover:bg-purple-100">Attention RNN Model (Attrnn.h5)</SelectItem>
                  <SelectItem value="gru.h5" className="hover:bg-purple-100">GRU Model (gru.h5)</SelectItem>
                  <SelectItem value="lstm.h5" className="hover:bg-purple-100">LSTM Model (lstm.h5)</SelectItem>
                  <SelectItem value="rnn.h5" className="hover:bg-purple-100">RNN Model (rnn.h5)</SelectItem>
                </SelectContent>
              </Select>
            </div>
